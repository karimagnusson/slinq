...
object RowTypeNames {
  ...
  protected val baseColTypeName: TypeCol[?] => String = {
    ...
    case col => throw SlinqError(s"Unsupported column: [${col.getClass.getName}]")
  }

  protected val colTypeName: TypeCol[?] => String = {
    case col: OptCol[?] =>
  ...
  def validate(cols: Vector[TypeCol[?]], fields: Vector[String]): Unit = {
